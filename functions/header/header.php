...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
    ...
    <body id="default_theme" class="it_service" onload="onload()">
    <!-- loader -->
          ...
          <div class="row">
            ...
            <div class="col-md-4 right_section_header_top">
              <div class="float-right">
                    <?php if(isset($_SESSION["mail"]) && isset($_SESSION["titre"])):?>
                          ...
                          <div class="make_appo">
                                <?php  if($_SESSION["titre"]== '21') :?>
                                    <a class="btn white_btn DC" href='../index/profil_intervenant.php'>Mon compte</a>
                                    
                                  <?php elseif($_SESSION["titre"]== '22') :?>
                                    <a class="btn white_btn DC" href='../index/profil_formateur.php'>Mon compte</a>

                                  <?php elseif($_SESSION["titre"]== '20') :?>
                                  <a class="btn white_btn DC" href='../index/profil_stagiaire.php'>Mon compte</a>
                                  <?php else :?>
                                  <a class="btn white_btn DC" href='../session/connexion.php'>Mon compte</a>
              ...
              <div class="menu_side navmenu">
                <div id="navbar_menu">
                  <ul class="first-ul">
                    ...
                    <li> <a href="#">Service</a>
                      <ul>
                        <li><a href="../index/formation.php">Formation</a></li>
                        <li><a href="../index/projet.php">Projet</a></li>
                      </ul>
                    </li>
                    <li> <a href="#">Profils</a>
                      <ul>
                        <li><a href="../index/nos_stagiaires.php">Stagiaire</a></li>
                        <li><a href="../index/nos_intervenants.php">Intervenant</a></li>
                        <li><a href="../index/nos_formateurs.php">Formateur</a></li>
                      </ul>
                    </li>
                    ...
                    <li> <a href="../session/contact.php">Contact</a></li>
